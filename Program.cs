...
// Create EF DbContext and repositories/services
...
var memberService = new LibraryManagementSystem.Application.Services.MemberService(memberRepository);
var bookService = new LibraryManagementSystem.Application.Services.BookService(bookRepository);
var borrowingService = new LibraryManagementSystem.Application.Services.BorrowingService(borrowingRepository, memberService, bookService);
...
void AddBook()
{
    ...
    if (bookService.SearchById(id) != null)
    {
...
void UpdateBook()
{
    ...
    Book? existingBook = bookService.SearchById(id);
...
void SearchBook()
{
    ...
    {
        int id = ReadInt("Enter Book Id: ");
        book = bookService.SearchById(id);
    }
